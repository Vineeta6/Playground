...
console.log(module.exports.favoriteAuthor = favoriteAuthor);  
console.log(module.exports.favoriteBook = favoriteBook);  
console.log(module.exports.getBookRecommendations = getBookRecommendations);  
